...
exports.create = async (req, res, next) => {
	...
	try {
		const contactService = await new ContactService(MongoDB.client);
...
exports.update = async (req, res, next) => {
	if (Object.keys(req.body).length === 0) return next(new ApiError(400, "Data to update can not be empty"));
...
exports.deleteAll = async (req, res, next) => {
	try {
		...
		return next(new ApiError(500, `An error occurred while remove all contacts`));
	}
};
